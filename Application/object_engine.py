    ...
    try:
        ...
        # 2.0 Begin processing batch matching string or regex against selected target fields
            ...
            for to_index, to_object in target_objects.items():
                ...
                with open('/Users/justinfilip/Documents/GitHub/Object_Engine/Objects/' + str(param_field[5]) + '/' + str(target_objects[to_index]), 'r') as engaged_object, open('/Users/justinfilip/Documents/GitHub/Object_Engine/Search Results/' + str(param_field[5]) + '_' + str(target_objects[to_index]) + '_' + str(datetime.now()) + '.csv', "w+") as results:
